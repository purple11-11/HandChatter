        ...
        <div className={`${styles.CAM}`}>
            <div className={`${styles.videoAndButtonContainer}`}>
                ...
                <div className={`${styles.left}`}>
                    ...
                    <div className={`${styles.chatting_for_one}`}>
                        ...
                        <div className={`${styles.chatting_input}`}>
                            <form
            ...
            <div className={`${styles.btnBox}`}>
                <div>
                    ...
                    <button className={`${styles.camBtn}`} onClick={CamMute}>
                        카메라 {isCameraOn ? "켜기" : "끄기"}
                    </button>
                    <button className={`${styles.exitBtn}`} onClick={ChattExit}>
                        나가기
                    </button>
                </div>
            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <h4 style={{ textAlign: "center", marginBottom: "10px" }}>
                                    강사님의 강의가 도움이 되셨나요? 별점과 후기를 모두 작성해주세요
                                </h4>
                                ...
                                />{" "}
                                <br />
                                <button onClick={closeModal} style={{ marginRight: "30px" }}>
                                    뒤로가기
                                </button>
                                <button onClick={sendReview} style={{ marginLeft: "30px" }}>
                                    보내기
                                </button>
                            </div>
                        </div>
